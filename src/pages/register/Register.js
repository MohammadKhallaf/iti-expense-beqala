        ...
        <div className='row justify-content-center'>
          <div className='col-lg-4 col-md-6 col-sm-12'>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className='container-fluid  justify-content-start input my-4 mx-0 px-0'>
                  <div className='row passwdBox justify-content-start py-0 mx-1' >
                    ...
                    <div className='col-lg-2 col-md-2 col-sm-2 pt-2 text-end '>
                      ...
                      <button className='togglePasswd' style={Regdisplayi.show} onClick={showRegPassword}> <i className={RemoveRedEyeIcon}></i></button>
                      <button className='togglePasswd' style={Regdisplayi.hide} onClick={hideRegPassword}>  <i className={VisibilityOffIcon}></i> </button>
                    </div>
                  </div>
                </div>
              ...
              <button type="submit" className="btn  my-4 sub">Submit</button>
            </form>
