        ...
        <div className="container ">
          <div className="row justify-content-center feature1 ">
            <div className="col-lg-4 col-md-3 col-sm-12 mx-5 ">
              <h2 className="featurette-heading my-5 pt-5">With Us</h2>
              <p className="lead my-5">
                You will find all you needs in one place with a less
                ccomplications
              </p>
              <p>
          ...
          <div className="row featurette">
            <div className="col-lg-4 col-md-3 order-md-2 text-center ">
              <h2 className="featurette-heading pt-5">you can</h2>
              <p className="lead my-5">
          ...
          <div className="row featurette py-5">
            <div className="col-md-7">
              <h2 className="featurette-heading pt-5">And lastly, this one.</h2>
              <p className="lead my-5">
